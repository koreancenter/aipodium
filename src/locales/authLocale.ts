...
export const AUTH_TRANSLATIONS: Record<AuthLang, AuthStrings> = {
  KR: {
    ...
    subtitle: 'Refined SSOT Generator',
    heroTitle: '연구자를 위한 비공개 지식 워크스페이스',
    heroDesc: 'AI Podium은 외부 서버 동기화 없이 프라이버시가 보장되는 AI 지원 환경에서 파편화된 지식을 정제하여 살아있는 SSOT로 생성해 드립니다.',
    card1Title: '100% 완전 로컬 저장',
    card1Desc: '작성한 연구 노트와 인용문은 브라우저의 격리된 로컬 저장소에만 보관됩니다. 중앙 클라우드 데이터베이스나 추적 서버가 없어 외부 유출 염려가 없습니다.',
    card2Title: '원활한 AI 노트 및 논문 종합 분석',
    card2Desc: '복잡한 학술 논문과 강의 노트를 직관적인 마크다운 요약본, 구조화된 개요 및 참고 자료 표로 신속하게 정리할 수 있습니다.',
    card3Title: '비상 마스터 복구 키',
    card3Desc: '독립적인 16자리 백업 키를 통해 원격 계정이나 외부 지원 없이도 연구 자료에 대한 접근 권한을 언제든 안전하게 복원할 수 있습니다.',
    copyright: '© 2026 aipodium.net · AI Podium',
    privacyPolicy: '개인정보 처리방침',
    termsOfUse: '이용약관',
    academicDisclaimer: '학술 면책 고지',
    offlineReady: '100% 오프라인 작동 가능',
    encryptedStorage: '암호화된 로컬 저장소',
    ...
    newPinLabel: '워크스페이스 PIN (최소 4자 이상)',
    newPinPlaceholder: '4자 이상 입력',
    ...
    recoveryVerificationDesc: 'PIN을 재설정하려면 16자리 비상 마스터 복구 키(4자리씩 4개 그룹)를 입력하세요.',
    ...
    newPinAfterRecoveryPlaceholder: '새 워크스페이스 PIN (최소 4자)',
    confirmNewPinAfterRecoveryPlaceholder: '새 PIN 확인',
    ...
    cooldownActive: '보안 대기 시간이 활성화되었습니다 (5회 실패).',
  ...
  ENG: {
    ...
    heroDesc: 'AI Podium refines fragmented knowledge and transforms it into a living Single Source of Truth (SSOT) within an AI-enabled environment that guarantees privacy—without the need for external server synchronization.',
    card1Title: '100% Local Privacy',
    card1Desc: "Your notes and citations are stored entirely inside your browser's private sandbox. No central cloud database, no tracking, and no external leaks.",
    card2Title: 'Seamless AI Note & Document Synthesis',
    card2Desc: 'Distill complex journal articles and lecture notes into living markdown syntheses, structured outlines, and reference tables.',
    card3Title: 'Emergency Master Access Key',
    card3Desc: 'Self-sovereign 16-character backup key ensuring you can always restore access to your thesis drafts without remote dependencies.',
    copyright: '© 2026 aipodium.net · AI Podium',
    privacyPolicy: 'Privacy Policy',
    termsOfUse: 'Terms of Use',
    academicDisclaimer: 'Academic Disclaimer',
    offlineReady: '100% Offline Capable',
    ...
    newPinLabel: 'Workspace PIN (min. 4 characters)',
    ...
    recoveryVerificationDesc: 'Enter your 16-character Emergency Master Access Key (e.g. 4 groups of 4 characters) to reset your PIN.',
    recoveryKeyPlaceholder: 'XXXX-XXXX-XXXX-XXXX',
    ...
    newPinAfterRecoveryPlaceholder: 'New Workspace PIN (min. 4 chars)',
    ...
    cooldownActive: 'Security cooldown active (5 attempts).',
